...
Java_com_superpowered_playerexample_AudioEnginBridge_nativeInit(JNIEnv *env, jobject instance, jint sampleRate, jint bufferSize) {
    superpoweredPlayer = new SuperpoweredPlayer(sampleRate, bufferSize);


}
extern "C" JNIEXPORT void JNICALL
Java_com_superpowered_playerexample_AudioEnginBridge_nativePlay(JNIEnv *env, jobject instance, jint index) {

    superpoweredPlayer->play(index);
}

extern "C" JNIEXPORT void JNICALL
Java_com_superpowered_playerexample_AudioEnginBridge_nativePause(JNIEnv *env, jobject instance) {
    superpoweredPlayer->pause();
}

extern "C" JNIEXPORT void JNICALL
Java_com_superpowered_playerexample_AudioEnginBridge_nativeStop(JNIEnv *env, jobject instance) {
    superpoweredPlayer->stop();
}

extern "C" JNIEXPORT jboolean JNICALL
Java_com_superpowered_playerexample_AudioEnginBridge_nativeIsPlaying(JNIEnv *env, jobject instance) {
    return static_cast<jboolean>(superpoweredPlayer->isPlaying());
}

extern "C" JNIEXPORT jint JNICALL
Java_com_superpowered_playerexample_AudioEnginBridge_getCurrentPosition(JNIEnv *env, jobject thiz) {
    return superpoweredPlayer->getPlayHeadCurrentPosition();
}
extern "C" JNIEXPORT jint JNICALL
Java_com_superpowered_playerexample_AudioEnginBridge_getDuration(JNIEnv *env, jobject thiz) {
    return  superpoweredPlayer->getTrackDuration();
}
extern "C" JNIEXPORT void JNICALL
Java_com_superpowered_playerexample_AudioEnginBridge_setPosition(JNIEnv *env, jobject thiz,
                                                                 jint position) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_superpowered_playerexample_AudioEnginBridge_nativeAddSongToPlaylist(JNIEnv *env, jobject instance, jstring filePath_) {
...
Java_com_superpowered_playerexample_AudioEnginBridge_onBackground(JNIEnv *__unused env,
...
extern "C" JNIEXPORT void
Java_com_superpowered_playerexample_AudioEnginBridge_onForeground(JNIEnv *__unused env, jobject __unused obj) {
    superpoweredPlayer->activityOnResume();
}

// Cleanup - Free resources.
extern "C" JNIEXPORT void
Java_com_superpowered_playerexample_AudioEnginBridge_Cleanup(JNIEnv *__unused env, jobject __unused obj) {
superpoweredPlayer->cleanResourses();
}

extern "C" JNIEXPORT void JNICALL
Java_com_superpowered_playerexample_AudioEnginBridge_nativePlayNext(JNIEnv *env, jobject instance, jobjectArray playNextList) {
...
Java_com_superpowered_playerexample_AudioEnginBridge_onUserInterfaceUpdate(JNIEnv *env, jobject thiz) {
...
Java_com_superpowered_playerexample_AudioEnginBridge_openfilefrom_1path(JNIEnv *env, jobject thiz,
                                                                        jstring path) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_superpowered_playerexample_AudioEnginBridge_toggle_1playback_1test_1playandpause(
