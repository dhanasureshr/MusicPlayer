...
Java_com_superpowered_playerexample_MainActivity_NativeInit(JNIEnv *env, jobject __unused obj,
...
extern "C" JNIEXPORT void
Java_com_superpowered_playerexample_MainActivity_onBackground(JNIEnv *__unused env,
                                                              jobject __unused obj) {
...
extern "C" JNIEXPORT void
Java_com_superpowered_playerexample_MainActivity_onForeground(JNIEnv *__unused env,
                                                              jobject __unused obj) {
...
extern "C" JNIEXPORT void
Java_com_superpowered_playerexample_MainActivity_Cleanup(JNIEnv *__unused env,
                                                         jobject __unused obj) {
    delete audioIO;
    delete player;
}
